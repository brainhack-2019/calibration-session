...
trials = data.TrialHandler(nReps=2, method='fullRandom', 
    ...
    trialList=data.importConditions('../../../../../../../../../../../../Users/paulpierzchlewicz/Documents/BrainHack/experiment_setup/trials.csv'),
